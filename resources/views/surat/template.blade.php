...
<body>
    ...
    <center>
        <div class="custom-atas">
            ...
            <p style="text-align: right; margin-right:70px;">Kudus, <b>{{ date('d-m-Y', strtotime($surats->created_at)) }}</b></p>
            </div>
    </center>
    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
            <div class="p">
                <p><strong>Nomor Surat: {{ $surats->nomor_surat2 }}</strong></p>
                <p><strong>Lampiran:</strong> -</p>
                <p><strong>Perihal: {{ $surats->keterangan }}</strong></p>
            </div>
            
            <div class="p2" style="text-align: right;">
                <p>
                    <strong  style="margin-right:79px;">KEPADA YTH,</strong><br>
                    <span style="margin-right:81px; display: inline-block; max-width: 150px; word-wrap: break-word; word-break: break-word; text-align: left;">{{ $surats->kepada }}</span><br>
...
<script>
    window.onload = function() {
        const statusSurat = @json($surats->status); // Status surat dari server
